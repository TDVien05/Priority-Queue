...
public class Lib {
    ...
    public static Customer getCustomer() {
        String name = getString("Input customer's name : ");
        String address = getString("Input customer's address : ");
        String phone = getString("Input customer's phone : ");
        Priority pri = null;
        ...
        Customer cus = new Customer(name, address, phone, pri);
        return cus;
    }
